...
# Курсовая
# Программа должна определить часть речи слова на татарском языке,
...
def noun_check(word: str) -> str: # Проверка слова на существительное.
  ...
  cases_list = ["ның", "нең", "ны", "не", "га",
    ...
    существительные основного падежа не определяются этой функцией.
    """
...
# Проверка слова на глагол.
def verb_check(word: str, words: list, word_number: int) -> str:
          ...
          if impersonal != "": # Проверка на неличные формы глагола.
            if impersonal in ["у", "ү"]:
              ...
              if action_name == "имя действия":
                 return "имя действия"
                 """
                 Имя действия изменяется и как глагол, и как существительное,
...
def action_name_check(
    word: str, voice: str, negation: str,
    repeatability: str, impersonal: str) -> str:
...
def adjective_check(word: str) -> str: # Проверка на прилагательное/наречие.
...
def numeral_check(word: str) -> str: # Проверка на числительное.
...
def pronoun_check(word: str) -> str: # Проверка на местоимения.
...
def function_word_check(word: str) -> str: # Проверка на служебное слово.
...
def check_undefined_words(words: list) -> list:
  if len(words) == 1:
...
for sentence in sentences:
  ...
  new_words = check_undefined_words(words)
